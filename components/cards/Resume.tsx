  ...
  return (
    <Card className="h-full">
      <p className="text-lg xl:text-2xl font-medium text-primary-foreground">
        Welcome to my portfolio! I am a skilled web developer with expertise in
        HTML, CSS, JavaScript, TypeScript, React, NextJS, TailwindCSS,
        Material-UI, SASS/SCSS, NodeJS, Express, and MongoDB. Through various
      ...
      <div className="flex items-center justify-between md:absolute md:bottom-6 md:left-6 md:w-[calc(100%-48px)]">
        ...
        <Socials />
        <Link
          href="./assets/resumes/Rohit_Kirti_resume.pdf"
          target="_blank"
